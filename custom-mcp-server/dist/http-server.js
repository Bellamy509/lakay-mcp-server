...
function categorizeeProblem(problem) {
    ...
    if (problem.toLowerCase().includes("bug"))
        return "Problème technique";
    if (problem.toLowerCase().includes("user") ||
...
async function executeAnalyzeProblem(args) {
...
async function executeStepByStepThinking(args) {
...
async function executeProsAndCons(args) {
...
async function executeCreativeBrainstorm(args) {
